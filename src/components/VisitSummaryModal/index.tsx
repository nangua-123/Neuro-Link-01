    ...
    >
      <div className="space-y-4">
        ...
        {!summary && !isGenerating && (
          <div className="bg-blue-50/50 border border-blue-100 rounded-[12px] p-3 text-center space-y-1.5">
            <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-1">
              <Sparkles className="w-4 h-4 text-blue-500" />
            </div>
            <h4 className="text-[12px] font-bold text-blue-900">AI 智能总结</h4>
            <p className="text-[10px] text-blue-700/80 leading-relaxed">
              基于您近期的打卡记录、体征数据与量表结果，一键生成结构化的真实世界证据 (RWE) 摘要，方便医生快速了解您的病情变化。
            </p>
            <Button 
              block 
              className="mt-2 bg-blue-600 text-white border-none rounded-[10px] h-9 font-bold text-[12px] shadow-[0_2px_8px_rgba(37,99,235,0.2)]"
        ...
        {summary && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-2.5">
            <div className="bg-white border border-slate-200 rounded-[12px] p-3 shadow-sm relative overflow-hidden">
              <div className="absolute top-0 right-0 w-12 h-12 bg-blue-50 rounded-full blur-xl -mr-6 -mt-6" />
