...
import { Switch, List, Toast, Modal } from 'antd-mobile';
import { Shield, User, QrCode, FileText, ChevronRight, LogOut } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import NeuroPassModal from '../../components/NeuroPassModal';

export default function ProfileView() {
  const { hasSignedAgreement, signAgreement, revokeAgreement, clearAuth } = useAppStore();
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] p-5 pb-24">
      ...
      {/* Module C: Asset List */}
      <div className="bg-white rounded-[28px] p-2 shadow-[0_4px_20px_rgba(0,0,0,0.02)] border border-slate-100/50 overflow-hidden mb-5">
      ...
      <button 
        ...
        className="w-full bg-white rounded-[28px] p-4 shadow-[0_4px_20px_rgba(0,0,0,0.02)] border border-slate-100/50 flex items-center justify-center gap-2 text-rose-500 font-medium active:bg-rose-50 transition-colors"
      >
